...
export declare function requestChangeCaseAndCleanup(request: RequestType, caseChangeFunc: (key: string) => string): RequestType;
...
export declare function transcode(request: RequestType, parsedOptions: ParsedOptionsType, requestFields?: {
    [k: string]: Field;
